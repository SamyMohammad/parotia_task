...
// import 'package:parotia_task/core/firebase/firebase_error_model.dart';

// // FirebaseErrorModel _handleError(DioException error) {
// //   switch (error.type) {
...
//     } else {
//       // default error
//       firebaseErrorModel = DataSource.DEFAULT.getFailure();
//     }
//   }
// }
...
//       FirebaseErrors.noContent; // success with no data (no content)
//   static const String BAD_REQUEST =
//       FirebaseErrors.badRequestError; // failure, API rejected request
//   static const String UNAUTORISED =
//       FirebaseErrors.unauthorizedError; // failure, user is not authorised
//   static const String FORBIDDEN =
//       FirebaseErrors.forbiddenError; //  failure, API rejected request
//   static const String INTERNAL_SERVER_ERROR =
//       FirebaseErrors.internalServerError; // failure, crash in server side
//   static const String NOT_FOUND =
//       FirebaseErrors.notFoundError; // failure, crash in server side
